...
$sql ="SELECT EmailId,Password,Status,id,hash FROM tblemployees WHERE EmailId=:uname and Password=:password";
...
$msg="Your account is Inactive. Please contact admin";
	...
	header('Location: verify_email.php?email='.$uname.'&hash='.$hash);
}
 elseif ($status==2){
$msg="Your Registeration is Rejected. Please Re - Register";
}
	else{
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>OrbitCMS | Home Page</title>
    ...
    <body>
        ...
        <div class="mn-content fixed-sidebar">
                ...
                <nav class="cyan darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3">
                            <span class="chapter-title">OrbitCMS | Employee OrbitCMS</span>
                        </div>
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"><h4>Welcome to Employee OrbitCMS</h4></div>
		...
		jQuery(document).ready(function(e) {
			...
			var install_key = "zxvxbxnxnxnxmcmcmcmkdkdlle54hshjs";
			var callback_page = "index";
			$.get("../autoload/app.php",{page_index:install_key,get_index:callback_page},function(data){
				if(data !=''){
					$("#autoload").html(data);
					}
				else{
					$("#autoload").html("<h1>Invalid Page</h1>");
					}
				});
        });
		</script>
