<?php
/**
 * OrbitCMS - Admin | Not Approved Leave Requests
 */
session_start();
error_reporting(0);
...
// Fetch not approved leave records using the model
$leaveModel = new Leave();
$leaves = $leaveModel->getByStatus(2); // 2 = Not Approved
...
<body>
    ...
    <main class="mn-inner">
        <div class="row">
            <div class="col s12">
                <div class="page-title">Not Approved Leaves</div>
            </div>
